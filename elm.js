...
Elm.Html.Shorthand.make = function (_elm) {
   ...
   var button$ = function (p) {
      return $Html.button(_L.fromArray([class$(p.$class)
                                       ...
                                       ,$Html$Events.onClick(p.update.onClick)]));
   };
...
Elm.IIFYM = Elm.IIFYM || {};
Elm.IIFYM.make = function (_elm) {
   "use strict";
   _elm.IIFYM = _elm.IIFYM || {};
   if (_elm.IIFYM.values)
   return _elm.IIFYM.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var macroValues = function (_v0) {
      return function () {
         ...
         _L.fromArray([A2($Html.h2,
                      ...
                      _L.fromArray([$Html$Attributes.id("protein")]),
                      _L.fromArray([A2($Html.b,
                                   _L.fromArray([]),
                                   _L.fromArray([$Html.text("Protein: ")]))
                                   ,$Html.text(A2($Basics._op["++"],
                                   $Basics.toString($Basics.round(_v0.protein)),
                                   A2($Basics._op["++"],
                                   " cals ",
                                   A2($Basics._op["++"],
                                   "(",
                                   A2($Basics._op["++"],
                                   $Basics.toString($Basics.round(_v0.protein / 4)),
                                   " g)")))))]))]))
                      ,A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("col-md-4 coll-md-offset-4")]),
                      _L.fromArray([A2($Html.p,
                      _L.fromArray([$Html$Attributes.id("fat")]),
                      _L.fromArray([A2($Html.b,
                                   _L.fromArray([]),
                                   _L.fromArray([$Html.text("Fat: ")]))
                                   ,$Html.text(A2($Basics._op["++"],
                                   $Basics.toString($Basics.round(_v0.fat)),
                                   A2($Basics._op["++"],
                                   " cals ",
                                   A2($Basics._op["++"],
                                   "(",
                                   A2($Basics._op["++"],
                                   $Basics.toString($Basics.round(_v0.carbs / 9)),
                                   " g)")))))]))]))
                      ,A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("col-md-4 coll-md-offset-8")]),
                      _L.fromArray([A2($Html.p,
                      _L.fromArray([$Html$Attributes.id("carbs")]),
                      _L.fromArray([A2($Html.b,
                                   _L.fromArray([]),
                                   _L.fromArray([$Html.text("Carbohydrate: ")]))
                                   ,$Html.text(A2($Basics._op["++"],
                                   $Basics.toString($Basics.round(_v0.carbs)),
                                   A2($Basics._op["++"],
                                   " cals ",
                                   A2($Basics._op["++"],
                                   "(",
                                   A2($Basics._op["++"],
                                   $Basics.toString($Basics.round(_v0.carbs / 4)),
                                   " g)")))))]))]))]));
      }();
   };
   var calcKMA = function (_v2) {
      return function () {
         return $Basics.round(370.0 + 21.6 * ((1 - _v2.fatPerc / 100) * _v2.weight));
      }();
   };
   var calcMSJ = function (_v4) {
      return function () {
         return function () {
            var baseVal = 10 * _v4.weight + 6.25 * _v4.height - 5 * $Basics.toFloat(_v4.age);
            return function () {
               var _v6 = _v4.gender;
               switch (_v6.ctor)
               {case "Female":
                  return $Basics.round(baseVal - 161);
                  case "Male":
                  return $Basics.round(baseVal + 5);}
               _U.badCase($moduleName,
   ...
   var calcBMR = function (info) {
      return function () {
         var _v7 = info.bmrEquation;
         switch (_v7.ctor)
         {case "KatchMcArdle":
            return calcKMA(info);
            case "MiffinStJeor":
   ...
   var calcTDEE = F2(function (bmr,
   _v8) {
      return function () {
         return function () {
            var fBMR = $Basics.toFloat(bmr);
            return function () {
               var _v10 = _v8.intensity;
               switch (_v10.ctor)
               {case "DailyPhysicalJob":
                  return fBMR * 1.9;
                  case "EveryDay":
                  return fBMR * 1.637;
                  case "EveryDayIntense":
                  return fBMR * 1.725;
                  case "Five":
                  return fBMR * 1.462;
                  case "FiveIntense":
                  ...
                  case "Four":
                  return fBMR * 1.418;
                  case "No": return fBMR * 1.2;
                  case "Six": return fBMR * 1.5;
                  case "Three":
                  return fBMR * 1.375;
                  case "TwiceDaily":
                  return fBMR * 1.725;}
      ...
      return function () {
         return function () {
            ...
            {case "Bulk":
               ...
               return tdee * 1.0;}
            _U.badCase($moduleName,
            "between lines 139 and 144");
         }();
      }();
   });
   var calcMacros$ = F2(function (goal,
   _v14) {
      return function () {
         return function () {
            var _v16 = _v14.macroFormula;
            switch (_v16.ctor)
            {case "LowFat": return {_: {}
                                   ,carbs: 0.6 * goal
                                   ,fat: 0.15 * goal
                                   ,protein: 0.25 * goal};
               case "TextBook": return {_: {}
                                       ,carbs: 0.5 * goal
                                       ,fat: 0.25 * goal
                                       ,protein: 0.25 * goal};
               case "ZoneDiet": return {_: {}
                                       ,carbs: 0.4 * goal
                                       ,fat: 0.3 * goal
                                       ,protein: 0.3 * goal};}
            _U.badCase($moduleName,
   ...
   var calcMacros = function (info) {
      return function () {
         var bmr = calcBMR(info);
         var tdee = A2(calcTDEE,
         bmr,
         info);
         var goal = A2(calcGoal,
         tdee,
         info);
         return A2(calcMacros$,
         goal,
         info);
      }();
   };
   ...
   _v17) {
      return function () {
         return function () {
            var info$ = function () {
               switch (action.ctor)
               {case "NoOp": return _v17.info;
                  case "UpdateAge":
                  return _U.replace([["age"
                                     ,action._0]],
                    _v17.info);
                  case "UpdateBMREquation":
                  return _U.replace([["bmrEquation"
                                     ,action._0]],
                    _v17.info);
                  case "UpdateFatPerc":
                  return _U.replace([["fatPerc"
                                     ,action._0]],
                    _v17.info);
                  case "UpdateGender":
                  return _U.replace([["gender"
                                     ,action._0]],
                    _v17.info);
                  case "UpdateGoal":
                  return _U.replace([["goal"
                                     ,action._0]],
                    _v17.info);
                  case "UpdateHeight":
                  return _U.replace([["height"
                  ...
                  return _U.replace([["intensity"
                                     ,action._0]],
                    _v17.info);
                  case "UpdateMacroFormula":
                  return _U.replace([["macroFormula"
                                     ,action._0]],
                    _v17.info);
                  case "UpdateWeight":
                  return _U.replace([["weight"
                                     ,action._0]],
                    _v17.info);}
               _U.badCase($moduleName,
               "between lines 89 and 109");
            }();
            return {_: {}
                   ,info: info$
   ...
   var LowFat = {ctor: "LowFat"};
   var ZoneDiet = {ctor: "ZoneDiet"};
   var TextBook = {ctor: "TextBook"};
   var BulkHard = {ctor: "BulkHard"};
   var Bulk = {ctor: "Bulk"};
   var Maintain = {ctor: "Maintain"};
   var Cut = {ctor: "Cut"};
   var CutHard = {ctor: "CutHard"};
   var DailyPhysicalJob = {ctor: "DailyPhysicalJob"};
   var TwiceDaily = {ctor: "TwiceDaily"};
   var EveryDayIntense = {ctor: "EveryDayIntense"};
   var EveryDay = {ctor: "EveryDay"};
   var FiveIntense = {ctor: "FiveIntense"};
   var Six = {ctor: "Six"};
   var Five = {ctor: "Five"};
   var Four = {ctor: "Four"};
   var Three = {ctor: "Three"};
   var No = {ctor: "No"};
   var KatchMcArdle = {ctor: "KatchMcArdle"};
   var MiffinStJeor = {ctor: "MiffinStJeor"};
   var Female = {ctor: "Female"};
   var Male = {ctor: "Male"};
   var UpdateUnits = function (a) {
      return {ctor: "UpdateUnits"
             ,_0: a};
   };
   var UpdateGoal = function (a) {
      return {ctor: "UpdateGoal"
             ,_0: a};
   };
   var UpdateMacroFormula = function (a) {
      return {ctor: "UpdateMacroFormula"
             ,_0: a};
   };
   var UpdateBMREquation = function (a) {
      return {ctor: "UpdateBMREquation"
             ,_0: a};
   };
   var UpdateIntensity = function (a) {
      return {ctor: "UpdateIntensity"
             ,_0: a};
   };
   var UpdateFatPerc = function (a) {
      return {ctor: "UpdateFatPerc"
             ,_0: a};
   };
   var UpdateWeight = function (a) {
      return {ctor: "UpdateWeight"
             ,_0: a};
   };
   ...
   var UpdateAge = function (a) {
      return {ctor: "UpdateAge"
             ,_0: a};
   };
   var UpdateGender = function (a) {
      return {ctor: "UpdateGender"
             ,_0: a};
   };
   var NoOp = {ctor: "NoOp"};
   var updates = $Signal.channel(NoOp);
   var ageInput = function (info) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("form-group col-md-4")]),
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for("age-input")]),
                   _L.fromArray([$Html.text("Age: ")]))
                   ,$Html$Shorthand.inputInt$({_: {}
                                              ,$class: "form-control"
                                              ,max: $Maybe.Nothing
                                              ,min: $Maybe.Just(0)
                                              ,name: "age-input"
                                              ...
                                              ,step: $Maybe.Nothing
                                              ,update: $Html$Shorthand.fieldUpdateContinuous({_: {}
   ...
   var heightInput = function (info) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("form-group col-md-4")]),
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for("height-input")]),
                   _L.fromArray([$Html.text("Height (cm): ")]))
                   ,$Html$Shorthand.inputFloat$({_: {}
                                                ,$class: "form-control"
                                                ,max: $Maybe.Nothing
                                                ,min: $Maybe.Just(0.0)
                                                ,name: "height-input"
   ...
   var weightInput = function (info) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("form-group col-md-4")]),
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for("weight-input")]),
                   _L.fromArray([$Html.text("Weight (kg): ")]))
                   ,$Html$Shorthand.inputFloat$({_: {}
                                                ,$class: "form-control"
                                                ,max: $Maybe.Nothing
                                                ,min: $Maybe.Just(0.0)
   ...
   var fatPercInput = function (info) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("form-group col-md-4")]),
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for("fat-perc-input")]),
                   _L.fromArray([$Html.text("Body fat (%): ")]))
                   ,$Html$Shorthand.inputFloat$({_: {}
                                                ,$class: "form-control"
                                                ,max: $Maybe.Nothing
                                                ,min: $Maybe.Just(0.0)
   ...
   var mkSelectField = F2(function (infoVal,
   _v29) {
      return function () {
         switch (_v29.ctor)
         {case "_Tuple2":
              ...
              {case "_Tuple2":
                 return A2($Html.option,
                   _L.fromArray([A3($Html$Events.on,
                                ...
                                $Html$Events.targetValue,
                                function ($) {
                                   return $Signal.send(updates)(function (val) {
                                      return A2($Debug.log,
                                      "onClick",
                                      _v29._1._0);
                                   }($));
                                })
                                ,$Html$Attributes.id(_v29._0)
                                ,$Html$Attributes.selected(_U.eq(infoVal,
                                _v29._1._1))]),
                   _L.fromArray([$Html.text(_v29._0)]));}
              break;}
         _U.badCase($moduleName,
         "between lines 402 and 405");
      }();
   });
   var mkSelect = F2(function (infoVal,
   fieldLst) {
      return function () {
         var lookup = $Dict.fromList(fieldLst);
         var action = function (a) {
            return function () {
               var _v35 = A2($Dict.get,
               a,
               lookup);
               switch (_v35.ctor)
               {case "Just":
                  return $Basics.fst(_v35._0);
                  case "Nothing": return NoOp;}
               _U.badCase($moduleName,
               "between lines 388 and 391");
            }();
         };
         return A2($Html.div,
         ...
         A2($List.map,
         mkSelectField(infoVal),
         fieldLst))]));
      }();
   });
   var bmrInput = function (info) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("form-group col-md-4")]),
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for("bmr-equation-input")]),
                   _L.fromArray([$Html.text("Which equation should be used?")]))
                   ,A2(mkSelect,
                   info.bmrEquation,
                   _L.fromArray([{ctor: "_Tuple2"
                                 ,_0: "Miffin St Jeor (better for those with low body fat)"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateBMREquation(MiffinStJeor)
                                      ,_1: MiffinStJeor}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Katch McArdle (better for those who know their body fat percentage)"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateBMREquation(KatchMcArdle)
                                      ,_1: KatchMcArdle}}]))]));
   };
   var genderInput = function (info) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("form-group col-md-4")]),
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for("gender-input")]),
                   _L.fromArray([$Html.text("What is your gender?")]))
                   ,A2(mkSelect,
                   info.gender,
                   _L.fromArray([{ctor: "_Tuple2"
                                 ,_0: "Male"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateGender(Male)
                                      ,_1: Male}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Female"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateGender(Female)
                                      ,_1: Female}}]))]));
   };
   var intensityInput = function (info) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("form-group")]),
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for("intensity-input")]),
                   _L.fromArray([$Html.text("How often do you exercise?")]))
                   ,A2(mkSelect,
                   info.intensity,
                   _L.fromArray([{ctor: "_Tuple2"
                                 ,_0: "Never"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateIntensity(No)
                                      ,_1: No}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Three times a week"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateIntensity(Three)
                                      ,_1: Three}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Four times a week"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateIntensity(Four)
                                      ,_1: Four}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Five times a week"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateIntensity(Five)
                                      ,_1: Five}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Six times a week"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateIntensity(Six)
                                      ,_1: Six}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Five times a week (intense)"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateIntensity(FiveIntense)
                                      ,_1: FiveIntense}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Every day"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateIntensity(EveryDay)
                                      ,_1: EveryDay}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Twice daily"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateIntensity(TwiceDaily)
                                      ,_1: TwiceDaily}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Every day, and I work a physical job"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateIntensity(DailyPhysicalJob)
                                      ,_1: DailyPhysicalJob}}]))]));
   };
   var macroInput = function (info) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("form-group")]),
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for("macro-formula-input")]),
                   _L.fromArray([$Html.text("Which formula should be used to calculate macros?")]))
                   ,A2(mkSelect,
                   info.macroFormula,
                   _L.fromArray([{ctor: "_Tuple2"
                                 ,_0: "Textbook (P:25%, F:25%, C:50%)"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateMacroFormula(TextBook)
                                      ,_1: TextBook}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Zone Diet (P:30%, F:30%, C:40%)"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateMacroFormula(ZoneDiet)
                                      ,_1: ZoneDiet}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Low Fat (P:25%, F:15%, C:60%"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateMacroFormula(LowFat)
                                      ,_1: LowFat}}]))]));
   };
   var goalInput = function (info) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("form-group")]),
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for("goal-input")]),
                   _L.fromArray([$Html.text("What is your goal?")]))
                   ,A2(mkSelect,
                   info.goal,
                   _L.fromArray([{ctor: "_Tuple2"
                                 ,_0: "Cut Hard (-20% calories)"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateGoal(CutHard)
                                      ,_1: CutHard}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Cut (-15% calories)"
                                 ,_1: {ctor: "_Tuple2"
                                ...
                                ,{ctor: "_Tuple2"
                                 ...
                                 ,_1: {ctor: "_Tuple2"
                                      ...
                                      ,_1: Bulk}}
                                ,{ctor: "_Tuple2"
                                 ,_0: "Bulk Hard (+10% calories)"
                                 ,_1: {ctor: "_Tuple2"
                                      ,_0: UpdateGoal(BulkHard)
                                      ,_1: BulkHard}}]))]));
   };
   var infoInputs = function (info) {
      return A2($Html.form,
      _L.fromArray([$Html$Attributes.$class("form")]),
      _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("row")]),
                   _L.fromArray([A2($Html.div,
                                _L.fromArray([$Html$Attributes.$class("row")]),
                                _L.fromArray([ageInput(info)
                                             ,heightInput(info)
                                             ,genderInput(info)]))
                                ,A2($Html.div,
                                _L.fromArray([$Html$Attributes.$class("row")]),
                                _L.fromArray([weightInput(info)
                                             ,fatPercInput(info)
                                             ,bmrInput(info)]))]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("row")]),
                   _L.fromArray([macroInput(info)]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("row")]),
                   _L.fromArray([intensityInput(info)]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("row")]),
                   _L.fromArray([goalInput(info)]))]));
   };
   var view = function (model) {
      ...
      _L.fromArray([A2($Html.h1,
                   _L.fromArray([$Html$Attributes.$class("text-center")]),
                   _L.fromArray([$Html.text("Simple IIFYM calculator")]))
                   ,A2($Html.br,
                   _L.fromArray([]),
                   _L.fromArray([]))
                   ,A2($Html.section,
                   _L.fromArray([$Html$Attributes.id("infoInputs")]),
                   _L.fromArray([infoInputs(model.info)]))
                   ,A2($Html.hr,
                   _L.fromArray([]),
                   _L.fromArray([]))
                   ,A2($Html.section,
                   _L.fromArray([$Html$Attributes.id("macroValues")]),
                   _L.fromArray([macroValues(model.macros)]))]))]))]));
   };
   var Macros = F3(function (a,
   b,
   c) {
      return {_: {}
             ,carbs: b
   ...
   _elm.IIFYM.values = {_op: _op
                       ...
                       ,UpdateFatPerc: UpdateFatPerc
                       ,UpdateIntensity: UpdateIntensity
                       ,UpdateBMREquation: UpdateBMREquation
                       ,UpdateMacroFormula: UpdateMacroFormula
                       ...
                       ,Five: Five
                       ,Six: Six
                       ,FiveIntense: FiveIntense
                       ,EveryDay: EveryDay
                       ,EveryDayIntense: EveryDayIntense
                       ,TwiceDaily: TwiceDaily
                       ,DailyPhysicalJob: DailyPhysicalJob
                       ,CutHard: CutHard
                       ,Cut: Cut
                       ,Maintain: Maintain
                       ,Bulk: Bulk
